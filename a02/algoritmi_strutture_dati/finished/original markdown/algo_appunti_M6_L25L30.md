...
In un albero binario perfettamente bilanciato quindi la ricerca avviene in $\mathcal{O}(\log n)$, ma l'inserimento può richiedere l'intera ristrutturazione dell'albero con una complessità di $\mathcal{O}(n)$. 	`[1]*`
